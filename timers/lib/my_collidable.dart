...
class MyCollidable extends CircleComponent
    with HasGameRef<CaseStudy005Exercise002>, CollisionCallbacks {
  ...
  Future<void> onLoad() async {
    await FlameAudio.audioCache.load('ball_bounce_off_ball.mp3');
    add(_healthText);
    return super.onLoad();
  }
    ...
    if (other is MyCollidable) {
      ...
      if (collisions.containsKey(other.hashCode.toString())) {
        ...
        if (gameRef.observedCollisions.contains(collisionKey)) {
          ...
          /// generate efx sound
          FlameAudio.play('ball_bounce_off_ball.mp3');
        }
